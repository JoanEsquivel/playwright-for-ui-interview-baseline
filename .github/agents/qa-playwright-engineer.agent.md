...
---
<!-- GENERATED by scripts/sync-agent-config.mjs from .claude/agents/qa-playwright-engineer.md — edit the source, then run `sync:agents` -->
...
Before starting any task, load these skills from `.claude/skills/` (Copilot discovers them automatically): `playwright-architecture`, `playwright-cli`. Load the task skill named in the routing table when you reach it.
