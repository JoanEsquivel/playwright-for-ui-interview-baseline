...
- The QA agent is `qa-engineer` (`.claude/agents/qa-engineer.md`); it preloads `playwright-architecture` and `playwright-cli` and keeps project memory in `.claude/agent-memory/qa-engineer/`.
